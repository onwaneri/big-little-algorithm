    ...
    <div className="overflow-x-auto rounded-lg border border-gray-200 shadow-sm">
      <table className="w-full text-sm">
        <thead className="bg-gray-50 text-gray-600 uppercase text-xs">
          <tr>
            <th className="px-4 py-3 text-left">Little</th>
            <th className="px-4 py-3 text-left">Big 1</th>
            <th className="px-4 py-3 text-left">Big 2</th>
            <th className="px-3 py-3 text-center">Little %</th>
        ...
        <tbody className="divide-y divide-gray-100">
          {rows.map((r) => (
            <tr key={r.freshman} className={r.big_2 ? "bg-amber-50" : "hover:bg-gray-50"}>
